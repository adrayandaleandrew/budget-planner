...
export class ExpenseComponent {
  ...
  selectedMonth: string;
   ...
   // START EXPENSE PRESET VALUES FOR EACH MONTH
  ...
  // ONCHANGE EVENT WHEN SELECTING MONTH
  ...
  // GET FILTERED EXPENSE BASED ON MONTH CHOSEN
  getFilteredExpenses() {
  ...
  // SAVE FORM and GIVE FEEDBACK IN CONSOLE
  saveForm() {
    console.log("Form saved!");
  }

   // BUTTON -  RETURN BACK TO DASHBOARD
  onBack() {
